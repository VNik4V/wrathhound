...
const sql = {
    ...
    deletepost: 'DELETE FROM forum WHERE post_id = ? AND (uid = ? OR (SELECT role FROM users WHERE uid = ?) = "admin")',
    deletecomment: 'DELETE FROM forum_comments WHERE comment_id = ? AND (uid = ? OR (SELECT role FROM users WHERE uid = ?) = "admin")',
    editpost: null,
